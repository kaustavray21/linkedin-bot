...
from app.api import auth_router, discovery_router, generate_router, health_router, media_router, posts_router, profile_router, scheduler_router, reference_router
